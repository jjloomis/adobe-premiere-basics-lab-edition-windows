...
* [Downloading media files from YouTube to your project folder](setting-up-your-project/copying-media-files-from-youtube-to-your-project-folder.md)
* [Downloading free music to your project folder](setting-up-your-project/downloading-free-music-to-your-project-folder.md)
* [Previewing and renaming clips](setting-up-your-project/previewing-and-renaming-clips-in-finder.md)
* [Opening Premiere](setting-up-your-project/opening-premiere.md)
* [Creating a Premiere project](setting-up-your-project/creating-a-premiere-project-file.md)
...
* [Adding In and Out points to a clip](importing-and-logging-clips/adding-in-and-out-points-to-clips.md)
...
* [Adding an audio clip to your sequence](editing-in-the-timeline-panel/adding-an-audio-clip-to-your-sequence.md)
* [Arranging items in your sequence](editing-in-the-timeline-panel/arranging-clips-in-your-sequence.md)
* [Trimming or extending an item in your sequence](editing-in-the-timeline-panel/trimming-a-clip.md)
* [Deleting an item in your sequence](editing-in-the-timeline-panel/deleting-clips-in-your-sequence.md)
* [Zooming in and out](editing-in-the-timeline-panel/zooming-in-and-out.md)
* [Muting timeline audio scrubbing](editing-in-the-timeline-panel/muting-audio-scrubbing.md)
...
* [Downloading a JAMS Text Template to Your Project Folder](adding-text-and-transitions/downloading-the-jams-text-template-to-your-project-folder.md)
* [Opening a JAMS Text Template](adding-text-and-transitions/opening-the-jams-social-media-video-text-template.md)
* [Adding a JAMS Text Template to Your Sequence](adding-text-and-transitions/adding-the-jams-social-media-video-text-template-to-your-sequence.md)
* [Working with Text in a JAMS Text Template](adding-text-and-transitions/working-with-text-in-the-text-template.md)
* [Adding the Media Milwaukee End Screen to Your Sequence](adding-text-and-transitions/adding-the-media-milwaukee-end-screen-to-your-sequence.md)
* [Adding a cross disolve](adding-text-and-transitions/adding-a-cross-disolve.md)
* [Adding a dip to black transition](adding-text-and-transitions/adding-a-dip-to-black-transition.md)

## Exporting

* [Exporting a still image from your sequence](exporting/exporting-a-still-image.md)
* [Exporting an MP4](exporting/exporting-an-mov.md)
