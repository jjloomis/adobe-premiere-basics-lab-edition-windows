...
3. In **Media Encoder**, right-click **H.264** in the **Queue** area in the upper-right. Select **Export Settings**.
...
<figure><img src="../.gitbook/assets/media-encoder-export-settings.png" alt=""><figcaption><p>Media Encoder Export Settings box.</p></figcaption></figure>
